...
- **endpoint** : Base URL of the space (e.g. `https://sgp1.digitaloceanspaces.com`)
...
- **cdn** : CDN Endpoint - URL of the cdn of the space (Optionnal - e.g. `https://your-bucket.sgp1.cdn.digitaloceanspaces.com`)
